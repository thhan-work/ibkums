...
<ul>
    <li><a href="/authAllMSG.ibk?emplId=normal">[0 : 일반사용자]로 인증</a></li>
    <li><a href="/authAllMSG.ibk?emplId=17489">[0 : 개인사용자]로 인증</a></li>
    <li><a href="/authAllMSG.ibk?emplId=employee">[1: 직원용 SMS 발송 등록자]로 인증</a></li>
    <li><a href="/authAllMSG.ibk?emplId=authorizer">[2: 승인자] 인증</a></li>
    <li><a href="/authAllMSG.ibk?emplId=admin02">[9: 관리자] 로 인증</a></li>
</ul>
