                	...
                	<ul>
                      ...
                      <li class="mgb6">
                            ...
                            <span class="checkbox_default fn">
                              <input type="checkbox" id="reserveYN" />
                              <label for="reserveYN">예약발송</label>
                            </span>
                            <span>
...
//파일업로드 버튼 클릭시
  ...
  $(document).on('click', "#send-btn", function () {
	    ...
	    var reserve= $("#reserveYN").prop("checked");
  ...
  function fileSend(target) {
	      $.ajax({
		      url: '${pageContext.request.contextPath}/message/emplsendrequest',
		      type: 'POST',
		      ...
		      success: function (data) {
					...
					//예약 발송 시 
		            if($("#reserveYN").prop("checked")) { completeMsg = "예약 되었습니다."; }
...
//	             * Integer ETC_COUNT: 그외 알 수 없는 오류
  ...
  function redirectList() {
	    /* setTimeout(function () {
	      window.location.href = "${pageContext.request.contextPath}/emplsms/emplsend.ibk";
	    }, 100); */
  }
...
////현재시간으로 셋팅
  function initSetDate(){
  	  ...
  	  var yearVal = now.getFullYear();
    	  var monthVal = (""+(now.getMonth() + 1)).length < 2 ? "0"+(now.getMonth() + 1) : (now.getMonth() + 1);
