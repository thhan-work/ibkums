...
<!--popup-->
<div class="popup_wrap_help" id="help-message" style="display: none">
    <!-- top -->
    <div class="top">
        <div class="title">도움말</div>
        <div class="btn_close">
            <a href="javascript:;" id="help-dialog-close"><img src="${pageContext.request.contextPath}/static/images/btn_pop_close.png" alt="닫기" /></a>
        </div>
    </div>
    <!-- //top -->
    <!-- content -->
    <div class="content_pop">
        <div class="wrap_lmenu">
            <ul>
                ...
                <li class=""><a href="javascript:;" id="fileBulkSend">파일대량보내기</a></li>
                <li class="on"><a href="javascript:;" id="allAddress">전체 주소록</a></li>
                <li class=""><a href="javascript:;" id="personAddress">개인 주소록</a></li>
                <li class=""><a href="javascript:;" id="partAddress">부서공유 주소록</a></li>
                <li class=""><a href="javascript:;" id="addressFile">주소록 파일 등록</a></li>
            </ul>
        </div>
        <div class="content_help">
            <div class="wrap_help">
                ...
                <div class="row1">
                    <div class="col1"><img src="${pageContext.request.contextPath}/static/images/help_img_001.png" alt="" style="width:500px;" /></div>
                    <div class="col2">
                        <ul>
            ...
            <div class="wrap_help">
                ...
                <div class="row1">
                    <div class="col1"><img src="${pageContext.request.contextPath}/static/images/help_img_002.png" alt="" style="width:500px;" /></div>
                    <div class="col2">
                        <ul>
            ...
            <div class="wrap_help">
                ...
                <div class="row1">
                    <div class="col1"><img src="${pageContext.request.contextPath}/static/images/help_img_003.png" alt="" style="width:500px;"/></div>
                    <div class="col2">
                        <ul>
                    ...
                    <div class="col1"><img src="${pageContext.request.contextPath}/static/images/help_img_004.png" alt="" style="width:500px;"/></div>
                    <div class="col2">
                        <ul>
            ...
            <div class="wrap_help">
                ...
                <div class="row1">
                    <div class="col1"><img src="${pageContext.request.contextPath}/static/images/help_img_005.png" alt="" style="width:500px;"/></div>
                    <div class="col2">
                        <ul>
            ...
            <div class="wrap_help">
                ...
                <div class="row1">
                    <div class="col1"><img src="${pageContext.request.contextPath}/static/images/help_img_006.png" alt="" style="width:500px;"/></div>
                    <div class="col2">
                        <ul>
...
<script>
  function showHelpAlert(callback) {
