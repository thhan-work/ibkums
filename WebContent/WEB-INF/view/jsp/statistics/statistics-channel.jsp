...
<div id="content">
    ...
    <div class="box_search01">
      <ul>
        <li>
			...
			<span class="title02 mgl15">단위업무코드</span>
			<span>
				<input type="text" maxlength="10" value="" id="job_code" style="width:120px">
			</span>
        </li>
      </ul>
    ...
    <div class="tbl_wrap_list">
        <table class="tbl_list" id="channel_statistics_table" summary="채널별 통계 테이블 입니다.">
            <colgroup>
                <col style="width:"/>
                <col style="width:"/>
...
//꼭!!! function(data) 처럼 함수로 정의를 해야 한다.
 ...
 // 검색 시작일 기본값 세팅
    ...
    IbkDataTable.initDataTable("channel_statistics_table", "./statistics-channel", requestParam,
    		IbkChannelStatisticsColumn.columns, IbkChannelStatisticsColumn.columnDefs);
  });
  ...
  $("#excel-btn").on('click', function () {
    ...
    $.fileDownload("./statistics-channel-excel.ibk",{
      httpMethod: "POST",
      data: data,
  ...
  function enterKeyListener() {
    // enter key event
    $("#job_code").keypress(function (event) {
      if (event.which == 13) {
