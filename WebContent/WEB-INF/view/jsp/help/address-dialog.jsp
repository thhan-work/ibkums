...
<!--popup-->
<div class="popup_wrap_help" id="alert-message" style="display: none">
    <!-- top -->
    <div class="top">
    ...
    <div class="content_pop">
        <div class="wrap_lmenu">
            <ul>
                ...
                <li class=""><a id="file" href="javascript:;">파일대량보내기</a></li>
                <li class="on"><a id="all" href="javascript:;">전체 주소록</a></li>
