...
<div id="content">
		...
		<!-- //페이징 --> 
		<!-- 버튼 -->
		<div class="btn_wrap01_list"><a href="javascript:;" class="btn_big blue" id="btn_SavePersonal">개인서식함 저장</a><a href="javascript:;" class="btn_big delete" id="btn_msgDelete">삭제</a></div>
		<!-- //버튼 --> 
</div>
<!-- //content --> 
...
$(document).on('click', '#btn_msgDelete', function(){
	  var selectData = $("#div_MsgFormDataView input[name=radio_preView]:checked");
	  ...
	  showConfirmDelete("선택한 메세지를 삭제 하시겠습니까?", deletePersonalForm);  
});

function deletePersonalForm(){
	  $.ajax({
	      url: '${pageContext.request.contextPath}/form/'+code+'/delete',
	      type: "DELETE",
	      contentType: "application/json; charset=utf-8",
	      dataType: "json",
	      data: JSON.stringify(msgFormInfo),
