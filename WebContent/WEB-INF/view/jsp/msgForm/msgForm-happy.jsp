...
<div id="content">
		...
		<div class="wrap_form">
				<div class="menu">
						<ul>
								<li><a href="javascript:;" <c:if test="${category == 1}">class="on"</c:if>>신규</a></li>
								<li><a href="javascript:;" <c:if test="${category == 2}">class="on"</c:if>>해피콜</a></li>
								<li><a href="javascript:;" <c:if test="${category == 8}">class="on"</c:if>>스마트뱅킹</a></li>
						</ul>
				</div>
