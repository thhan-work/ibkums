...
<!-- article -->
    ...
    <div id="content">
            ...
            <table class="tbl_view01" summary="검색조건 테이블입니다. 항목으로는 등이 있습니다">
                                ...
                                <div class="mgt20">
                                    <ul class="disib">
                                        <li class="disib">발신번호<span class="th_must">*</span>
                                                <input type="text" id="send-phonenum" class="mgl5" value="${smssendlist.sndrTelno}"
                                                       style="width:100px">
                                        </li>
                ...
                <tr <c:if test="${smssendlist.msgDstic eq 'SM'|| smssendlist.msgDstic eq 'LM'}"> style="display: none" </c:if> id="img-tr">
                    ...
                    <td>
                        <ul class="list01">
                            <li>
                                <input type="text"class="imgPath"  id="image-fileupload-input1" placeholder="파일 업로드" value="${smssendlist.imagePath1}" style="width:330px" readonly="readonly"> <!-- View 전용 파일명 -->
                                ...
                                <a href="javascript:" id="delete-image-file-btn1" class="btn_default small delete mgl6 vam00"
                                    <c:if test="${smssendlist.imagePath1 eq NULL}">  style="display:none;" </c:if>
                                >X</a>
                                <a href="javascript:" id="image-file-btn1" class="btn_default gray mgl6 vam00">선택</a>
                            </li>
                            <li>
                                <input type="text" class="imgPath" id="image-fileupload-input2" placeholder="파일 업로드" value="${smssendlist.imagePath2}" style="width:330px" readonly="readonly"> <!-- View 전용 파일명 -->
                                ...
                                <a href="javascript:" id="delete-image-file-btn2" class="btn_default small delete mgl6 vam00"
                                    <c:if test="${smssendlist.imagePath2 eq NULL}">  style="display:none;" </c:if>
                                >X</a>
                                <a href="javascript:" id="image-file-btn2" class="btn_default gray mgl6 vam00">선택</a>
                            </li>
                            <li>
                                <input type="text" class="imgPath" id="image-fileupload-input3" placeholder="파일 업로드" value="${smssendlist.imagePath3}" style="width:330px" readonly="readonly"> <!-- View 전용 파일명 -->
                                ...
                                <a href="javascript:" id="delete-image-file-btn3" class="btn_default small delete mgl6 vam00"
                                    <c:if test="${smssendlist.imagePath3 eq NULL}">  style="display:none;" </c:if>
                                >X</a>
                                <a href="javascript:" id="image-file-btn3" class="btn_default gray mgl6 vam00">선택</a>
                            </li>
                        </ul>
                        <div class="ment_sms01 mgt5">*최소1개, 최대3개 까지 가능합니다.<a href="javascript:" id="img-desc-btn" class="btn_small mgl15">이미지 규격</a></div>
                    </td>
                </tr>
        ...
        <div class="btn_wrap01_detail">
            <a href="javascript:" class="btn_big blue" id="confirm-req-btn">결재 올리기</a>
...
//     $("#default-emp-count").text(parseInt($("#default-emp-count").text()) - 1);
  ...
  function saveSmsReq(smsReqData){
    $.ajax({
      ...
      showAlert("결제 요청 하였습니다.", redirectList);
    }).fail(function(xhr) {
