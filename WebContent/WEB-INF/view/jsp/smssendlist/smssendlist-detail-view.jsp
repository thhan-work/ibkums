...
<h3>
    <c:choose>
        ...
        <c:when test="${smssendlist.prcssStusDstic  eq 'E'}">상세보기 > 발송취소</c:when>
    </c:choose>
</h3>
<!-- content -->
<div id="content">
    ...
    <div class="tbl_wrap_view">
        <table class="tbl_view01" summary="검색조건 테이블입니다. 항목으로는 등이 있습니다">
            ...
            <tr>
                <th scope="row">기안명</th>
                <td>
                    <input type="text" name="search" maxlength="333" id="request-title" value="${smssendlist.groupNm}"
            ...
            <tr>
                ...
                <td>
                    ...
                    <c:if test="${smssendlist.sendType eq 'noMarketing'}">
                        <input type="text" name="request-type" maxlength="333" id="request-type"
                               value="비마케팅(기존계약의 유지 · 관리 등)"
                               style="width:700px; border: none" readonly="readonly" onfocus="this.blur()">
                    </c:if>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input id="expect-count" type="text" name="" style="border: none" readonly="readonly"
                           onfocus="this.blur()">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" id="file-name-input"
                           style="width:330px; border: none" readonly="readonly" onfocus="this.blur()"
                           value="${smssendlist.inst}">
                </td>
            </tr>
            <tr>
                                    ...
                                    <div class="content">
                                        <div class="text_sms2" id="div-texarea" style="width:100%">
		                                        <textarea class="sms" id="content-textarea"
                                                          style="font-family:굴림; font-size:16px; width:100%; height:100%;"
                                                          readonly="readonly"
                                                          onfocus="this.blur()">${smssendlist.msgCtnt}</textarea>
                                        </div>
                                        <div class="byte">
                                            <span id="dis-total-byte">0</span>/<span id="dis-max-byte"> 90</span>byte
                                        </div>
                                    </div>
                                    <div class="mgt33 tac">
                                        <a href="javascript:" class="mgl6">
                                        <img id="preview-dialog-show-img" src="${pageContext.request.contextPath}/static/images/btn_sms02.png" alt="미리보기"/>
                                        </a>
                                    </div>
                                </div>
                            </c:when>
                                    ...
                                    <div class="content">
                                        <div class="title_sms" id="msg-title-div">
                                            <input class="sms" type="text" id="msg-title"
                                                   style="width:200px" readonly="readonly" onfocus="this.blur()"
                                                   value="${smssendlist.msgCtnt}">
                                        </div>
                                        <div
                                        ...
                                        >
		                                        <textarea class="sms" id="content-textarea"
                                                          style="font-family:굴림; font-size:16px; width:100%; height:100%"
                                                          readonly="readonly"
                                                          onfocus="this.blur()">${smssendlist.umsMsgCtnt}</textarea>
                                        </div>
                                        <div class="byte"><span id="dis-total-byte">0</span>/<span
                                                id="dis-max-byte"><c:if
                                                test="${smssendlist.msgDstic eq 'SM'}"> 90</c:if><c:if
                                                test="${smssendlist.msgDstic ne 'SM'}"> 2000</c:if></span>byte
                                        </div>
                                    </div>
                                    <div class="mgt33 tac">
                                        <a href="javascript:" class="mgl6">
                            ...
                            <div class="mgt20">
                                <ul class="disib">
                                    <li class="disib"><b>발신번호 :</b>
                                        <input type="text" id="send-phonenum" value="${smssendlist.sndrTelno}"
                                               class="mgl5" maxlength="16"
                                               style="width:100px; border:none; padding-bottom:6px; margin-left:-5px !important;"
                                               readonly="readonly" onfocus="this.blur()">
                                    </li>
                                    <div style="display: none;">
                                        <c:if test="${smssendlist.sendType eq 'marketing'}">
                                            <li class="disib mgl20" id="validation-num-li" style="display: none;"><span
                                                    style="vertical-align: middle; font-weight: bold;">심의필번호  :</span>
                                                <input type="text" id="validation-num" class="mgl5"
                                                       value="${smssendlist.censorId}"
                                                       style="width:90px; border: none" readonly="readonly"
                                                       onfocus="this.blur()">
                                            </li>
                                        </c:if>
                                    </div>
            ...
            <tr <c:if
                    test="${smssendlist.msgDstic eq 'SM'|| smssendlist.msgDstic eq 'LM'}"> style="display: none" </c:if>
                    id="img-tr">
            ...
            <tr id="tr_confirm-doc-name" style="display: none;">
                ...
                <td><input type="text" id="confirm-doc-name" maxlength="50"
                           style="width:650px; display: none;" readonly="readonly" onfocus="this.blur()"
                           value="${smssendlist.budgetNm}">
                </td>
            </tr>
            <tr>
                        ...
                        <ul class="faqBody">
                            <li class="article hide" id="a4">
                                ...
                                <div class="a" style="display: none;">
                                    <!-- table_view -->
                                    <div class="tbl_wrap_view_sms03"
                                         style="width:430px; border-top:1px solid #ffffff; margin-top:4px;">
                                        <table class="tbl_view01" summary="검색조건 테이블입니다. 항목으로는 등이 있습니다">
                                            <caption>
                                                검색조건 테이블입니다.
                                            </caption>
    ...
    <div class="btn_wrap01_detail">
        <c:if test="${smssendlist.prcssStusDstic  eq 'P'}">
            <a href="javascript:" class="btn_big gray disable" id="send-btn"
               title="발송일정이 현재보다 과거이므로 발송승인요청이 불가능합니다. 관리자에게 문의해주세요 (IT채널부 김성민과장)">발송승인 요청</a>
        </c:if>
        ...
        <c:if test="${smssendlist.prcssStusDstic  ne 'E'}">
