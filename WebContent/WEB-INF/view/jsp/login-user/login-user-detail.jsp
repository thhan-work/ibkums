      ...
      <div class="tbl_wrap_view">
        <table class="tbl_view01">
          ...
          <tr>
            ...
            <td><input type="password" name="passwd2" id="passwd2" value="" placeholder="" style="width:280px;"></td>
          </tr>
          <tr>
          ...
          <tr class="modifyItem">
            <th scope="row">비밀번호변경일시</th>
            <td colspan="3"><input type="text" name="pw_cn_dt" id="pw_cn_dt" value="" style="width:280px; background-color: lightgray;" readonly ></td>
          </tr>       
        </table>
      </div>
      <!-- //table_view -->
...
<script>
	...
	function check_id(){
	    ...
	    $.ajax({
	        url: '${pageContext.request.contextPath}/loginuser/' + $("#login_id").val() +'/count',
	            type: 'GET',
    ...
    $("#save_btn").on('click', function(){
    	...
    	if($('#passwd1').val()==$('#passwd2').val()&&$('#passwd1').val().trim()!=""){
    		chk_pw=true;
    	}

    	if(isModify && $('#passwd1').val().trim() == ""){
    		chk_pw=true;
    	}else{
        	if($('#passwd1').val()==$('#passwd2').val()&&$('#passwd1').val().trim()!=""){
        		chk_pw=true;
	...
	function getLoginUserInfo() {
	    return {   
	        "login_id": $("#login_id").val(),
	      	"passwd": $("#passwd1").val()==""?"":SHA256($("#passwd1").val()),
	      	"empl_id": $("#empl_id").val(),
  ...
  function setEmployeeInfo(result) {
	  ...
	  if(result.PW_CN_DT !=null)$("#pw_cn_dt").val(viewDate(result.PW_CN_DT));
