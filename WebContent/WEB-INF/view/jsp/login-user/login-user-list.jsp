...
<!-- user detail popup -->
<jsp:include page="login-user-detail.jsp" flush="true"/>
...
<script>
    ...
    var deleteTargetUrl = '${pageContext.request.contextPath}/loginuser/remove/';
    ...
    $(document).ready(function () {
        ...
        IbkDataTable.initDataTable("data_table", "../loginuser", requestParam,IbkContentsColumn.columns, IbkContentsColumn.columnDefs);
    ...
    $("#data_table").on('click', '.mod_btn', function () {
        $.ajax({
            url: '${pageContext.request.contextPath}/loginuser/' + $(this).prop('id'),
            type: 'GET',
