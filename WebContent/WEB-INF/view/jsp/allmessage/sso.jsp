...
// 		self.location.replace("http://localhost:8080/ibk/error/403");
		self.location.replace("/ssoAllMSG.ibk?ticket=123");
	}
...
<script language="javascript">
	...
	if(ticket.length==1){
		...
		if (response == true) {
			...
			self.location.replace("/error/403");
		}
		...
		self.location.replace("/ssoAllMSG.ibk?ticket=" + escape(ticket));
