...
<div class="alert_wrap" style="margin: auto; margin-top: 111px;"> 
  ...
  <div class="content_alert" style="border-top: 2px solid #155bb0; border-left: 1px solid #e8e8e8; border-right: 1px solid #e8e8e8; border-bottom: 1px solid #e8e8e8; height:116px;"> 
	<p style="font-size: 13px;"><b>현재 페이지는 사용하실 수 없습니다.<br></b>
	<b>${sessionScope.errorMsg}<br></b>
	<br>
	<br>
	<b>403 Session Error</b></p>
  </div>
  <!-- //content --> 
