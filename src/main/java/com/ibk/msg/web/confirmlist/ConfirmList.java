...
/***TSUMSSU21  ***/		
	...
	private String  groupNm;		 	//그룹명 (파일명)
	...
	private String approvalYms; //승인일시
	...
	private String umsMsg; 				//sms, lms 내용
	...
	private String confirmYms;	// 승인(반려) 일시
	private String emplName;		// 기안자 명
	private String partName;		// 기안부서 명
	private String agreeName;	// 승인자 명
	private String agreeId;	// 승인자 명
